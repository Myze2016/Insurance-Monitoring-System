  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Add Loan<sup></sup></div>
      </a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800 border-bottom-primary pb-4 ">Add Loan</h1>
             ...
             <form class="justify-content-center p-2" method="POST" action="<?php echo base_url('save')?>" id="form">
                 ...
                 <div class="row col-6 offset-md-3">
                     <div class="form-group col-12">
                        <input type="text" class="form-control form-control-user" id="account" name="account" placeholder="Account Name">
                     ...
                     <div class="form-group col-6 animated--fade-in">
                    ...
                    <div class="form-group col-6">
                        <select type="text" class="form-control form-control-user" id="part" name="pnid" placeholder="Part Number">
                ...
                <div class="row col-6 offset-3">
                    <div class=" form-group col-12 text-center">
                        <input type="text" class="form-control form-control-user" id="amount" placeholder="Loan Amount" name="amount"/>
                        <label id="amount-error" class="small invalid-tooltip"></label>
                        </div>
                         <div class="col-12 form-group text-center"> 
                            <p class="col-12">
                            <label class="ml-3">12months</label>
                            <input type="radio" name="radio" value="option1">
                            <label class="ml-3">24months</label>
                            <input type="radio" name="radio" value="option2">
                            <label class="ml-3">36months</label>
                            <input type="radio" name="radio" value="option3"></p>
                        </div>
                    <div class="form-group col-12">
                        <input class="form-control form-control-user" id="datepicker" width="100%" placeholder="Maturity Date" name="maturity"/>
                ...
                <div class="row col-6 offset-3 form-group">
                    ...
                    <a href="<?php echo base_url(); ?>" class="btn btn-outline-danger col-3">Return </a></p>
                 </div>
